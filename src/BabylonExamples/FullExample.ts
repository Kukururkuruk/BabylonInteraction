...
Page(): void {
    ...
    const page1 = this.dialogPage.addText("Здравствуйте, сейчас вы измерите диаметры арматуры при помощи штангенциркуля ШЦ-1-150 0,1. Для начала нажмите на подсвеченную арматуру левой кнопкой мыши. \n\nДля перехода на следующую страницу нажмите кнопку 'Вперед'");
    const page1_1 = this.dialogPage.addText("Порядок измерения штангенциркулем: Зажмите деталь между (нижними) губками для наружнего измерения. \n\nДля фиксации подвижной рамки необходимо закрутить винт. \n\nВам необходимо изучить полученные показатели с основной шкалы в мм. Если показатель совпал с нулем на шкале нониуса, то это и есть точная целая цифра размера детали. \n\nЧтобы узнать размер детали с точностью до десятых или сотых мм., необходимо сперва вычислить цену деления нониуса. Она может быть 0,1 мм или 0,05 чаще. \n\nИзучите показатели на подвижной рамке на шкале, которая точно совпадает с риской на основной шкале. Вам нужно умножить получившиеся значение на цену деления шкалы нониуса (обычно 0,1 или 0,05 мм) и получить десятые или сотые значения. Сложите данные из 3 и 6 пунктов.");
